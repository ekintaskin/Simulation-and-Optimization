...
class Request:
    ...
    # Function defining the waiting time of customers, simply as difference between when they are served and when the request was created
    def get_waiting_time(self):
        """Calculate the waiting time (time_served - time_creation)."""
        if self.time_creation is not None and self.time_served is not None:
            return self.time_served - self.time_creation
        return 0  # Return 0 if waiting time cannot be calculated
